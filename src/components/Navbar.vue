      ...
      <div v-if="isOpen" class="lg:hidden bg-white shadow-lg">
        <div class="pt-4 pb-6 px-4 sm:px-5 space-y-2">
          <router-link
            ...
            :key="item.name"
            :to="item.path"
            class="block px-4 py-3 text-s sm:text-base font-semibold rounded-lg hover:bg-gray-50 hover:text-primary transition-all duration-200"
          ...
          <div class="px-4 py-3">
            <div class="text-s sm:text-base font-semibold text-gray-500 mb-3">{{ t('nav.services') }}</div>
            <div class="space-y-1">
              <router-link
